...
simulações, predições, ou computação gráfica - propriedades que não podem ser obtidas experimentalmente de forma direta. No entanto, usuários não especializados são, com frequência, desencorajados a usar tais instrumentos em função dos conceitos complexos e interfaces mal arquitetadas ou difíceis de lidar..
