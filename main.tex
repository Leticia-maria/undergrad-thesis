...
\siglalista{YAeHMOP}{Yet Another extended Hueckel Molecular Orbital Package}
\siglalista{DFT}{Density Functional Theory}
\siglalista{NICS}{Nucleus Independent Chemical Shift}
